...
идентичность и версию политики, идентичность оценки, `matched_rule`, объяснение и время.
`matched_rule` **ДОЛЖЕН** содержать индекс совпавшего правила или `null`, если применён fallback.
